...
- `https://xevos-ui.fun/r/registry.json`
- Example item: `https://xevos-ui.fun/r/text-animate.json`
...
```bash
npx shadcn@latest add @xevos-ui/text-animate
```

## Required change in `shadcn-ui/ui`

1. Open `apps/v4/registry/directory.json`.
2. Add an entry for Xevos UI (matching the current `registries.json` shape):

```json
{
  "name": "@xevos-ui",
  "homepage": "https://xevos-ui.fun",
  "url": "https://xevos-ui.fun/r/{name}.json",
...
- [ ] `https://xevos-ui.fun/r/registry.json` is publicly accessible.
